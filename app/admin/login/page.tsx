  ...
  return (
    <div className="flex min-h-dvh w-full flex-col items-center justify-center px-4 py-12 sm:px-6">
      <div className={`w-full max-w-sm p-8 ${storefrontSurfacePanel}`}>
        <h1 className="font-display text-xl font-semibold text-foreground">Oilix — админка</h1>
        <p className="mt-2 text-sm text-muted-foreground">Войдите по паролю администратора.</p>
        {!configured ? (
          <p className="mt-4 rounded-md border border-destructive/40 bg-destructive/10 px-3 py-2 text-sm text-destructive">
            Вход отключён, пока в окружении не задан{" "}
